export const AggregateQuestionsAnswers = (data)=>{
    ...
    let newData=[]
    let i = 0;
    data.forEach(({question_id,q_time,question,q_username,q_upvotes,q_verified,course_code,answer,ans_username,ans_upvotes,ans_downvotes,ans_time,ans_verified,id,filename,mimtype,data})=>{
